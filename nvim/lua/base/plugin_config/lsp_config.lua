...
local function setMappings(event)
  ...
  map('<leader>O', require('telescope.builtin').lsp_document_symbols, '[O]pen Document Symbols')
...
local function setDiag()
  vim.diagnostic.config {
    ...
    virutual_text=false,
 -- too much noise. open_diagnostic float or quickfix list ^^
 --[[   virtual_text = {  
      source = 'if_many',
      spacing = 2,
...
-- On lsp attach, set up keymaps, diagnostics
